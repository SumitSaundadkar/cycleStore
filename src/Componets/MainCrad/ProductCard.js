...
const ProductCard = ({ product }) => {
  ...
  const filteredProductList = filterByCategory(
    byRating(
      sortByPrice([...data], productListState.sortBy),
      productListState.rating
    ),
    productListState.categoryName
  );

  return (
    <div>
      <h2 className="product_length_heading">
        Showing All Product{" "}
        <span className="product_length">
